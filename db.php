...
");
*/
$con->query("CREATE TABLE `user_info` (
...
$con->query("INSERT INTO user_info ('user_id', 'first_name', 'last_name', 'email', 'password', 'mobile', 'address1', 'address2') VALUES
...
$con->query("ALTER TABLE `brands`
  ADD PRIMARY KEY (`brand_id`)");
// --
// -- Indexes for table `cart`
// --
$con->query("ALTER TABLE `cart`
  ADD PRIMARY KEY (`id`)");
...
// --
$con->query("ALTER TABLE `categories`
  ADD PRIMARY KEY (`cat_id`)");

// --
// -- Indexes for table `orders`
// --
$con->query("ALTER TABLE `orders`
  ADD PRIMARY KEY (`order_id`)");

// --
// -- Indexes for table `products`
// --
$con->query("ALTER TABLE `products`
  ADD PRIMARY KEY (`product_id`) ");

// --
// -- Indexes for table `user_info`
// --
$con->query("ALTER TABLE `user_info`
